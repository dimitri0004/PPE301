...
class DirecteurController extends AbstractController
{
    ...
    public function modifier( $id, Request $request, EntityManagerInterface $entityManagerInterface): Response
    {
    ...
    public function supprimer($id,DirecteurRepository $directeurRepository,EntityManagerInterface $entityManagerInterface): Response
    {
        $directeur= $entityManagerInterface->getRepository(Directeur::class)->find($id);
