...
class InscriptionEleveController extends AbstractController
{
    ...
    public function modifier(Request $request, $id, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
        ...
        public function supprimer($id,UsersEleves $usersEleves,EntityManagerInterface $entityManagerInterface): Response
        {
            $usersEleves= $entityManagerInterface->getRepository(Directeur::class)->find($id);
            $supprimer=$usersEleves->remove($usersEleves, true);
